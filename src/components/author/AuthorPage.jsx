...
function AuthorPage() {
    ...
    console.log(data)
    const { author:{name, field, avatar, decription, posts} } = data;
  return (
    <Container maxWidth="lg">
        <Grid container mt={10}>
            ...
            <Grid item xs={12}>
                {/* <div dangerouslySetInnerHTML={{__html: sanitizeHtml(decription.html)}}></div> */}
                <div dangerouslySetInnerHTML={{__html: decription.html}}></div>
            </Grid>
            <Grid item xs="12" mt={6}>
                <Typography component="h3" variant='h5' fontWeight={700} mt={4}>مقالات {name}</Typography>
            </Grid>
